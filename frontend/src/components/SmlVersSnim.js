...
const liaison = [
  { consomateur: "snim", ead: 0, erd: 0, eaf: 0, erf: 0, EA: 0, ER: 0 },
  { consomateur: "somlec", ead: 0, erd: 0, eaf: 0, erf: 0, EA: 0, ER: 0 },
];
...
const sendToServer = () => {
  axios.post("http://localhost:3009/add_liaison", liaison).then(
    (response) => {
